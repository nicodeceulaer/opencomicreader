...
public class PrefActivity extends PreferenceActivity implements Preference.OnPreferenceClickListener, Preference.OnPreferenceChangeListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isSinglePane(this))
			this.getFragmentManager().beginTransaction().replace(android.R.id.content, new CombinedFragment()).commit();
		else {
	...
	public boolean onPreferenceClick(Preference pref) {
		...
		if (key.equals("funcClearSeries")) {
			sage.ui.Dialogs.ConfirmBox(context, "Reset Series", "Are you sure you want to reset all the series names to blank?",
			...
			sage.ui.Dialogs.ConfirmBox(context, "Clear Cover Cache", "Are you sure you want to delete all the covers in the cache?",
					new DialogInterface.OnClickListener() {
						@Override
						public void onClick(DialogInterface dialog, int id) {
							ComicLibrary.clearCovers();
						}
					});
		}// if
	...
	public boolean onPreferenceChange(Preference preference, Object value) {
		...
		if (preference instanceof ListPreference) {
			...
			preference.setSummary(stringValue); // For all other preferences, set the summary to the value's simple string representation.
