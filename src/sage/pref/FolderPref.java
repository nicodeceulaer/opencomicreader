...
public class FolderPref extends DialogPreference implements DialogInterface.OnClickListener, MapAdapter.AdapterCallback, AdapterView.OnItemClickListener {
	...
	protected View onCreateDialogView() {
		...
		mAdapter.setListItemLayout(R.layout.listitem_dlgfolder); // this should by dynamic, remove dependency
	...
	public View onDisplayListItem(View v, Object key) {
		TextView tv = (TextView) v.findViewById(R.id.lblTitle);
		tv.setText(mFolderList.get(key).toString());
		v.setTag(key);
		return v;
	}// func
