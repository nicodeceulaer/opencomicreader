...
public class LibraryDrawerAdapter extends BaseExpandableListAdapter {
	...
	public LibraryDrawerAdapter(Context context, List<String> listDataHeader, HashMap<String, List<String>> listChildData) {
